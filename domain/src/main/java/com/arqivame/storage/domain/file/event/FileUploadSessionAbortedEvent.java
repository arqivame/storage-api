...
public class FileUploadSessionAbortedEvent extends Event<FileUploadSessionAbortedEvent.Data> {
    ...
    private FileUploadSessionAbortedEvent() {
    ...
    private FileUploadSessionAbortedEvent(
            ...
            FileUploadSessionAbortedEvent.Data data) {
    ...
    public static FileUploadSessionAbortedEvent create(final File file) {
        return new FileUploadSessionAbortedEvent(
                Instant.now(),
                Stream
