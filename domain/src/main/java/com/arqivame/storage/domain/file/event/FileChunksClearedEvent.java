...
public class FileChunksClearedEvent extends Event<FileChunksClearedEvent.Data> {

    private static final String ENTITY = "file";
    private static final String ACTION = "chunks-cleared";
    private static final String VERSION = "0.0.1";

    private static final FileChunksClearedEvent DEFAULT_INSTANCE = new FileChunksClearedEvent();

    private FileChunksClearedEvent() {
    ...
    private FileChunksClearedEvent(
            ...
            FileChunksClearedEvent.Data data) {
    ...
    public static FileChunksClearedEvent create(final File file) {
        return new FileChunksClearedEvent(
                Instant.now(),
                Stream
