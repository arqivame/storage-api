...
public class MaxConcurrentChunkReadsReachedException extends SilentApplicationException {
    ...
    private MaxConcurrentChunkReadsReachedException(final Integer maxConcurrentReads) {
        super(
                ...
                List.of(ApplicationException.Error.with(ERROR.formatted(Objects.requireNonNull(maxConcurrentReads)))));
    }
